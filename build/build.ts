...
buildESM({
	...
	external: ['novel-editor-core', '*/cssMode', '*/monaco.contribution']
});
buildAMD({
	base: 'language/css',
...
buildESM({
	...
	external: ['novel-editor-core', '*/htmlMode', '*/monaco.contribution']
});
buildAMD({
	base: 'language/html',
...
buildESM({
	...
	external: ['novel-editor-core', '*/jsonMode', '*/monaco.contribution']
});
buildAMD({
	base: 'language/json',
...
buildESM({
	...
	external: ['novel-editor-core', '*/tsMode', '*/monaco.contribution']
});
buildAMD({
	base: 'language/typescript',
...
glob('../src/basic-languages/*/*.contribution.ts', { cwd: __dirname }, function (err, files) {
	...
	// ESM
	{
		...
		const external = ['novel-editor-core', '*/_.contribution'];
